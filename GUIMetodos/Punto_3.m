...
if (signal ~= 0)
    ...
    b = 'M�todos de dos puntos: Modelo de primer orden de smith';
    c = 'M�todos de dos puntos: Modelo de primer orden-Ho';
    d = 'M�todos de dos puntos: Modelo de segundo m�s tiempo muerto orden-Ho';
    e = 'M�todos de la tangente:Ziegler y Nichols';
